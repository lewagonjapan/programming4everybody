...
Each Ruby file you see in this repository will be filled by a teacher during the corresponding session. In the [`slides`](https://github.com/lewagonjapan/programming4everybody/tree/july-2024/slides) folder you can see and download the slides we share during our lessons.
...
1. [`Introduction to Ruby`](https://github.com/lewagonjapan/programming4everybody/blob/july-2024/01_introduction.rb) Tuesday, July 16th
2. [`Control flow in Ruby`](https://github.com/lewagonjapan/programming4everybody/blob/july-2024/02_control_flow.rb) & [`Looping with Ruby`](https://github.com/lewagonjapan/programming4everybody/blob/july-2024/03_looping.rb) Thursday, July 18th
3. [`Arrays and Hashes`](https://github.com/lewagonjapan/programming4everybody/blob/july-2024/04_arrays_and_hashes.rb) & [`Blocks and Sorting`](https://github.com/lewagonjapan/programming4everybody/blob/july-2024/05_methods_and_blocks.rb) Tuesday, July 23rd
4. [`Hashes and Symbols`](https://github.com/lewagonjapan/programming4everybody/blob/july-2024/06_hashes_and_symbols.rb) Thursday, July 25th
5. [`Object-Oriented Programming, Part 1`](https://github.com/lewagonjapan/programming4everybody/blob/july-2024/09_oop.rb) & [`Part 2`](https://github.com/lewagonjapan/programming4everybody/blob/july-2024/10_oop.rb) Tuesday, July 30th
...
After the last lecture on Tuesday, July 30th, we will ask you to submit your Codecademy username to confirm completion of the Ruby track.
...
By completing this course, **you get a special 50,000¥ off the next Tokyo courses tuition** starting on **October 7th, 2024** for our full-time bootcamp, and **September 21st, 2024** for our part-time bootcamp! 🇯🇵
