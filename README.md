## Welcome to Programming for Everybody - Season 12!
...
Each Ruby file you see in this repository will be filled by a teacher during the corresponding session. In the [`slides`](https://github.com/lewagonjapan/programming4everybody/tree/feb-2023/slides) folder you can see and download the slides we share during our lessons.
...
1. [`Introduction to Ruby`](https://github.com/lewagonjapan/programming4everybody/blob/feb-2023/01_introduction.rb) Thursday, February 16th
2. [`Control flow in Ruby`](https://github.com/lewagonjapan/programming4everybody/blob/feb-2023/02_control_flow.rb) & [`Looping with Ruby`](https://github.com/lewagonjapan/programming4everybody/blob/feb-2023/03_looping.rb) Tuesday, February 21st
3. [`Arrays and Hashes`](https://github.com/lewagonjapan/programming4everybody/blob/feb-2023/04_arrays_and_hashes.rb) & [`Blocks and Sorting`](https://github.com/lewagonjapan/programming4everybody/blob/feb-2023/05_methods_and_blocks.rb) Thursday, February 23rd
4. [`Hashes and Symbols`](https://github.com/lewagonjapan/programming4everybody/blob/feb-2023/06_hashes_and_symbols.rb) Tuesday, February 28th
5. [`Object-Oriented Programming, Part 1`](https://github.com/lewagonjapan/programming4everybody/blob/feb-2023/09_oop.rb) & [`Part 2`](https://github.com/lewagonjapan/programming4everybody/blob/feb-2023/10_oop.rb) Thursday, March 2nd
...
By completing this course, **you get a special 50,000¥ off the next Tokyo courses tuition** starting on **April 3rd, 2023** for our full-time bootcamp, and **March 25th, 2023** for our part-time bootcamp! 🇯🇵
