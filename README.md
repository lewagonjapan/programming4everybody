## Welcome to Programming for Everybody - Season 13!
...
Each Ruby file you see in this repository will be filled by a teacher during the corresponding session. In the [`slides`](https://github.com/lewagonjapan/programming4everybody/tree/may-2023/slides) folder you can see and download the slides we share during our lessons.
...
1. [`Introduction to Ruby`](https://github.com/lewagonjapan/programming4everybody/blob/may-2023/01_introduction.rb) Tuesday, May 9th
2. [`Control flow in Ruby`](https://github.com/lewagonjapan/programming4everybody/blob/may-2023/02_control_flow.rb) & [`Looping with Ruby`](https://github.com/lewagonjapan/programming4everybody/blob/may-2023/03_looping.rb) Thursday, May 11th
3. [`Arrays and Hashes`](https://github.com/lewagonjapan/programming4everybody/blob/may-2023/04_arrays_and_hashes.rb) & [`Blocks and Sorting`](https://github.com/lewagonjapan/programming4everybody/blob/may-2023/05_methods_and_blocks.rb) Tuesday, May 16th
4. [`Hashes and Symbols`](https://github.com/lewagonjapan/programming4everybody/blob/may-2023/06_hashes_and_symbols.rb) Thursday, May 18th
5. [`Object-Oriented Programming, Part 1`](https://github.com/lewagonjapan/programming4everybody/blob/may-2023/09_oop.rb) & [`Part 2`](https://github.com/lewagonjapan/programming4everybody/blob/may-2023/10_oop.rb) Tuesday, May 23rd
...
After the last lecture on Tuesday, May 23rd, we will ask you to submit your Codecademy username to confirm completion of the Ruby track.
...
By completing this course, **you get a special 50,000¥ off the next Tokyo courses tuition** starting on **July 3rd, 2023** for our full-time bootcamp, and **September 23rd, 2023** for our part-time bootcamp! 🇯🇵
