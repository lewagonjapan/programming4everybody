## Welcome to Programming for Everybody - Season 11!
...
Each Ruby file you see in this repository will be filled by a teacher during the corresponding session. In the [`slides`](https://github.com/lewagonjapan/programming4everybody/tree/nov-2022/slides) folder you can see and download the slides we share during our lessons.
...
1. [`Introduction to Ruby`](https://github.com/lewagonjapan/programming4everybody/blob/nov-2022/01_introduction.rb) Tuesday, November 8th
2. [`Control flow in Ruby`](https://github.com/lewagonjapan/programming4everybody/blob/nov-2022/02_control_flow.rb) & [`Looping with Ruby`](https://github.com/lewagonjapan/programming4everybody/blob/nov-2022/03_looping.rb) Thursday, November 10th
3. [`Arrays and Hashes`](https://github.com/lewagonjapan/programming4everybody/blob/nov-2022/04_arrays_and_hashes.rb) & [`Blocks and Sorting`](https://github.com/lewagonjapan/programming4everybody/blob/nov-2022/05_methods_and_blocks.rb) Tuesday, November 15th
4. [`Hashes and Symbols`](https://github.com/lewagonjapan/programming4everybody/blob/nov-2022/06_hashes_and_symbols.rb) Thursday, November 17th
5. [`Refactoring`](https://github.com/lewagonjapan/programming4everybody/blob/nov-2022/07_refactoring.rb) & [`Procs and Lambdas`](https://github.com/lewagonjapan/programming4everybody/blob/nov-2022/08_procs_and_lambdas.rb) Tuesday, November 22nd
6. [`Object-Oriented Programming, Part 1`](https://github.com/lewagonjapan/programming4everybody/blob/nov-2022/09_oop.rb) & [`Part 2`](https://github.com/lewagonjapan/programming4everybody/blob/nov-2022/10_oop.rb) Thursday, November 24th
...
After the last lecture on Thursday, November 24th, we will ask you to submit your Codecademy username to confirm completion of the Ruby track.
...
By completing this course, **you get a special 50,000¥ off the next Tokyo courses tuition** starting on **January 9th, 2023** for our full-time bootcamp, and **March 25th, 2023** for our part-time bootcamp! 🇯🇵
