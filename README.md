## Welcome to Programming for Everybody - Season 5!
...
Each Ruby file you see in this repository will be filled by a teacher during the corresponding session. In the [`slides`](https://github.com/lewagonjapan/programming4everybody/tree/may-2021/slides) folder you can see and download the slides we share during our lessons.
...
![](https://github.com/lewagonjapan/programming4everybody/raw/may-2021/images/repl2.png)

![](https://github.com/lewagonjapan/programming4everybody/raw/may-2021/images/repl3.png)
...
1. [`Introduction to Ruby`](https://github.com/lewagonjapan/programming4everybody/blob/may-2021/01_introduction.rb) Tuesday, May 11th
2. [`Control flow in Ruby`](https://github.com/lewagonjapan/programming4everybody/blob/may-2021/02_control_flow.rb) & [`Looping with Ruby`](https://github.com/lewagonjapan/programming4everybody/blob/may-2021/03_looping.rb) Thursday, May 13th
3. [`Arrays and Hashes`](https://github.com/lewagonjapan/programming4everybody/may-2021/04_arrays_and_hashes.rb) & [`Blocks and Sorting`](https://github.com/lewagonjapan/programming4everybody/blob/may-2021/05_methods_and_blocks.rb) Tuesday, May 18th
4. [`Hashes and Symbols`](https://github.com/lewagonjapan/programming4everybody/blob/may-2021/06_hashes_and_symbols.rb) Thursday, May 20th
5. [`Refactoring`](https://github.com/lewagonjapan/programming4everybody/blob/may-2021/07_refactoring.rb) & [`Procs and Lambdas`](https://github.com/lewagonjapan/programming4everybody/blob/may-2021/08_procs_and_lambdas.rb) Tuesday, May 25th
6. [`Object-Oriented Programming, Part 1`](https://github.com/lewagonjapan/programming4everybody/blob/may-2021/09_oop.rb) & [`Part 2`](https://github.com/lewagonjapan/programming4everybody/blob/may-2021/10_oop.rb) Thursday, May 27th
...
After the last lecture on Thursday, May 27th, we will ask you to submit your Codecademy username to confirm completion of the Ruby track.
...
By completing this course, **you get a special 50,000¥ off the next Tokyo courses tuition** starting on **July 5th, 2021** for our full-time bootcamp, and **September 25th, 2021** for our part-time bootcamp! 🇯🇵
...
![](https://github.com/lewagonjapan/programming4everybody/raw/may-2021/images/IMG_2547.JPG)
